...
Figures or tables with long captions should provide only the first
sentence\index{caption@\verb+\caption+!first sentence} for the table
of contents. To do this, include the brief material as an optional
argument to \verb+\caption+:
\begin{ltxexample}
\caption[Here's the first sentence.]{Here's the first sentence. And
    here's additional text that will only be shown with the figure.}
\end{ltxexample}
...
changed references, reminding you to run the process step again.)
...
Since I've seen this mistake in many documents, I will highlight one
simple, subtle point here: treat equations as part of a paragraph.
\index{mathematics!spacing} In terms of typing your document, this
means that there should be no blank lines between text and displayed
equations. The example which follows is a common idiom, and how it
ought to be typed.
...
The common mistake is to insert blank lines around the equation to
help it stand out in your source text. But this also tells \LaTeX{} to
end one paragraph and begin another. Not only does this introduce
\emph{extra} vertical space between text and equation, subtly
disconnecting the two, but worse, the text following would be
indented, which is not proper for this common idiom. Of course, for a
situation where an equation actually does begin or end a paragraph,
then leave a blank line before or after, as appropriate.
